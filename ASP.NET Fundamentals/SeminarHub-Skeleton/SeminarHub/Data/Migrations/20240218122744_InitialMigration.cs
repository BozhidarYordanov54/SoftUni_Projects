        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Lecturer = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false, comment: "Lecturer name of the seminar."),
                    Details = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false, comment: "Details of the seminar."),
                    OrganizerId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Organizer ID."),
                    DateAndTime = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Date and time of the seminar."),
                    Duration = table.Column<int>(type: "int", nullable: false, comment: "Duration of the seminar in minutes."),
