...
namespace LogForU.Core.Loggers
{
    public class Logger : ILogger
    {
        ...
        private void AppendAll(string dateTime, string text, ReportLevel reportLevel) //TODO Report
        {
            IMessage message = new Message(dateTime, text, reportLevel); //TODO Validate
