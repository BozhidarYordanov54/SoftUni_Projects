    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                people.Add(new Person() { Name = information[0], Age = int.Parse(information[1]) });
            }
        ...
        private static Func<Person, int, bool> GetFilter(string filterType)
        {
        ...
        private static Action<Person> GetFormatter(string formatType)
        {
